...
time.sleep(3)
button = driver.find_element(By.XPATH, '//*[@id="level_select_13"]/span')
button.click()
...
def search_for_flags():
       for row in range(16):
              for column in range(30):
                     ...
                     elif (fake_mas[row][column].find('-9') == -1 and fake_mas[row][column].find('f') == -1 and row == 0 and column == 29):
                            if fake_mas[row][column-1].find('-9') != -1:
                                   count +=1
                            for y in range(-1,1):
                                   if fake_mas[row+1][column+y].find('-9') != -1:
                     ...
                     elif (fake_mas[row][column].find('-9') == -1 and fake_mas[row][column].find('f') == -1 and row == 15 and column == 29):
                            if fake_mas[row][column-1].find('-9') != -1:
                                   count +=1
                            for y in range(-1,1):
                                   if fake_mas[row-1][column+y].find('-9') != -1:
                     ...
                     elif (fake_mas[row][column].find('-9') == -1 and fake_mas[row][column].find('f') == -1 and row == 0 and column !=0 and column != 29):
                            if fake_mas[row][column - 1].find('-9') !=-1:
                                   count +=1
                            if fake_mas[row][column + 1].find('-9') !=-1:
                                   count +=1
                     ...
                     elif (fake_mas[row][column].find('-9') == -1 and fake_mas[row][column].find('f') == -1 and row == 15 and column !=0 and column != 29):
                            if fake_mas[row][column - 1].find('-9') !=-1:
                                   count +=1
                            if fake_mas[row][column + 1].find('-9') !=-1:
                                   count +=1
                     ...
                     # Если клетка в последнем столбце И не угловая И 1 И вокруг одна -1
                     elif (fake_mas[row][column].find('-9') == -1 and fake_mas[row][column].find('f') == -1 and row != 0 and row != 15 and column == 29):
                            if fake_mas[row - 1][column].find('-9') !=-1:
                                   count +=1
                            if fake_mas[row + 1][column].find('-9') !=-1:
                                   count +=1
                            for y in range(-1,2):
                                   if fake_mas[row+y][column - 1].find('-9') !=-1:
                                          count +=1
                     elif(fake_mas[row][column].find('-9') == -1 and fake_mas[row][column].find('f') == -1 and row != 0 and  column != 0 and row != 15 and  column != 29):
                            for x in range(-1,2):
                                   for y in range(-1,2):
       ...
       #============================================================================================================================
                     ...
                     if (fake_mas[row][column].find('-9') == -1 and fake_mas[row][column].find('f') == -1 and row == 0 and column == 29):
                            if fake_mas[row][column-1].find('-9') != -1 and count == 1:
                                   if count ==1: list_of_right_clicks.append((f'//*[@id="cell_{column-1}_{row}"]'))
                            if fake_mas[row+1][column].find('-9') != -1 and count == 1:
                                   if count ==1: list_of_right_clicks.append((f'//*[@id="cell_{column}_{row+1}"]'))
                     ...
                     if (fake_mas[row][column].find('-9') == -1 and fake_mas[row][column].find('f') == -1 and row == 15 and column == 29):
                            if fake_mas[row][column-1].find('-9') != -1 and count == 1:
                                   if count ==1: list_of_right_clicks.append((f'//*[@id="cell_{column-1}_{row}"]'))
                            if fake_mas[row-1][column].find('-9') != -1 and count == 1:
                                   if count ==1: list_of_right_clicks.append((f'//*[@id="cell_{column}_{row-1}"]'))
                            if fake_mas[row-1][column-1].find('-9') != -1 and count == 1:
                                   if count ==1: list_of_right_clicks.append((f'//*[@id="cell_{column-1}_{row-1}"]'))
                     # Если клетка в первом ряду И не угловая И 1 И вокруг одна -1
                     if (fake_mas[row][column].find('-9') == -1 and fake_mas[row][column].find('f') == -1 and row == 0 and column !=0 and column != 29):
                            if fake_mas[row][column - 1].find('-9') !=-1 and count == 1:
                                   if count ==1: list_of_right_clicks.append((f'//*[@id="cell_{column-1}_{row}"]'))
                            if fake_mas[row][column + 1].find('-9') !=-1 and count == 1:
                                   if count ==1: list_of_right_clicks.append((f'//*[@id="cell_{column+1}_{row}"]'))
                     ...
                     # Если клетка в последнем ряду И не угловая И 1 И вокруг одна -1
                     if (fake_mas[row][column].find('-9') == -1 and fake_mas[row][column].find('f') == -1 and row == 15 and column !=0 and column != 29):
                            if fake_mas[row][column - 1].find('-9') !=-1 and count == 1:
                                   if count ==1: list_of_right_clicks.append((f'//*[@id="cell_{column-1}_{row}"]'))
                            if fake_mas[row][column + 1].find('-9') !=-1 and count == 1:
                                   if count ==1: list_of_right_clicks.append((f'//*[@id="cell_{column+1}_{row}"]'))
                     ...
                     # Если клетка в последнем столбце И не угловая И 1 И вокруг одна -1
                     if (fake_mas[row][column].find('-9') == -1 and fake_mas[row][column].find('f') == -1 and row != 0 and row != 15 and column == 29):
                            if fake_mas[row - 1][column].find('-9') !=-1 and count == 1:
                                   if count ==1: list_of_right_clicks.append((f'//*[@id="cell_{column}_{row-1}"]'))
                            if fake_mas[row + 1][column].find('-9') !=-1 and count == 1:
                                   if count ==1: list_of_right_clicks.append((f'//*[@id="cell_{column}_{row+1}"]'))
