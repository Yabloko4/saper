              ...
              #============================================================================================================================
                            ...
                            if (fake_mas[row][column].find('-9') == -1 and fake_mas[row][column].find('f') == -1 and row == 0 and column == 0):
                                   if fake_mas[row][column+1].find('-9') != -1 and count == 1:
                                          if count ==1 and driver.find_element(By.XPATH, f'//*[@id="cell_{column+1}_{row}"]').get_attribute('class') != 'cell size24 hd_closed hd_flag': actionChains.context_click(driver.find_element(By.XPATH, f'//*[@id="cell_{column+1}_{row}"]')).perform()
                                   if fake_mas[row+1][column].find('-9') != -1 and count == 1:
                                          if count ==1 and driver.find_element(By.XPATH, f'//*[@id="cell_{column}_{row+1}"]').get_attribute('class') != 'cell size24 hd_closed hd_flag': actionChains.context_click(driver.find_element(By.XPATH, f'//*[@id="cell_{column}_{row+1}"]')).perform()
                                   if fake_mas[row+1][column+1].find('-9') != -1 and count == 1:
                                          if count ==1 and driver.find_element(By.XPATH, f'//*[@id="cell_{column+1}_{row+1}"]').get_attribute('class') != 'cell size24 hd_closed hd_flag': actionChains.context_click(driver.find_element(By.XPATH, f'//*[@id="cell_{column+1}_{row+1}"]')).perform()
                            ...
                            if (fake_mas[row][column].find('-9') == -1 and fake_mas[row][column].find('f') == -1 and row == 0 and column !=0 and column != 8):
                                   ...
                                   for y in range(-1,1):
                                          if fake_mas[row+1][column + y].find('-9') !=-1 and count == 1:
                                                 if count ==1 and driver.find_element(By.XPATH, f'//*[@id="cell_{column+y}_{row+1}"]').get_attribute('class') != 'cell size24 hd_closed hd_flag': actionChains.context_click(driver.find_element(By.XPATH, f'//*[@id="cell_{column+y}_{row+1}"]')).perform()
                            # Если клетка в последнем ряду И не угловая И 1 И вокруг одна -1
                            ...
                            if (fake_mas[row][column].find('-9') == -1 and fake_mas[row][column].find('f') == -1 and row != 0 and row != 8 and column == 0):
                                   ...
                                   for y in range(-1,1):
                                          if fake_mas[row+y][column + 1].find('-9') !=-1 and count == 1:
                                                 if count ==1 and driver.find_element(By.XPATH, f'//*[@id="cell_{column+1}_{row+y}"]').get_attribute('class') != 'cell size24 hd_closed hd_flag': actionChains.context_click(driver.find_element(By.XPATH, f'//*[@id="cell_{column+1}_{row+y}"]')).perform()
                            # Если клетка в последнем столбце И не угловая И 1 И вокруг одна -1
                            if (fake_mas[row][column].find('-9') == -1 and fake_mas[row][column].find('f') == -1 and row != 0 and row != 8 and column == 8):
                                   ...
                                   for x in range(-1,2):
                                          for y in range(-1,2):
                                                 if fake_mas[row + x][column+y].find('-9') !=-1:
                                                        if count ==1 and driver.find_element(By.XPATH, f'//*[@id="cell_{column+y}_{row+x}"]').get_attribute('class') != 'cell size24 hd_closed hd_flag': actionChains.context_click(driver.find_element(By.XPATH, f'//*[@id="cell_{column+y}_{row+x}"]')).perform()
                            count = 0
       search_for_flags()
